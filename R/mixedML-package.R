# https://roxygen2.r-lib.org/articles/namespace.html#functions-1

#' @importFrom lcmm hlme
#' @importFrom stats complete.cases terms update aggregate predict
#' @importFrom ggplot2 ggplot aes geom_line geom_point scale_y_log10 .data guides scale_shape_manual
#' guide_legend ggtitle scale_linetype_manual xlim ylim
#' @import patchwork
