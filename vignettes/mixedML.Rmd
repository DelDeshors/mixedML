...
preventing the use of Rstudio and favor running from terminal let's simply write a standard R script and call it from
terminal redirecting both stdout and stderr to a log file:
