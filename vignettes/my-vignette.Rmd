...
<br>
The purely fixed effects response, $y_{fixed}$ is calculated as:
$$y_{fixed} = \gamma_{0} + 
\gamma_{1} \cdot  x_2 \cdot x_5 + 
\gamma_{2} \cdot  x_4 \cdot x_7 +
\gamma_{3} \cdot  x_6 \cdot x_8$$
… where $\gamma_{0}= -0.9826036$, $\gamma_{1} = -0.4289147$, $\gamma_{2} = -0.0456483$ and $\gamma_{3} = -0.8542527$

<br>
The mixed effects response, $y_{mixed}$ is calculated for each individual $i$ as:
